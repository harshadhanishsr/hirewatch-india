...
CITY_MAP = {
    ...
    "chandigarh":"Chandigarh","lucknow":"Lucknow","bhopal":"Bhopal",
    ...
    "bhubaneswar":"Bhubaneswar","dehradun":"Dehradun","nashik":"Nashik",
    "rajkot":"Rajkot","madurai":"Madurai","ranchi":"Ranchi",
    "guwahati":"Guwahati","jodhpur":"Jodhpur","vijayawada":"Vijayawada",
    "faridabad":"Faridabad","ghaziabad":"Ghaziabad","hubli":"Hubballi",
    "hubballi":"Hubballi","mangalore":"Mangaluru","mangaluru":"Mangaluru",
    "udaipur":"Udaipur","aurangabad":"Aurangabad","thane":"Thane",
    "kota":"Kota","kozhikode":"Kozhikode","calicut":"Kozhikode",
    "warangal":"Warangal","raipur":"Raipur","varanasi":"Varanasi",
    "agra":"Agra","amritsar":"Amritsar","jabalpur":"Jabalpur",
...
CITY_COORDS = {
    ...
    "Guwahati":[26.1445,91.7362],"Jodhpur":[26.2389,73.0243],
    "Vijayawada":[16.5062,80.6480],"Faridabad":[28.4089,77.3178],
    "Ghaziabad":[28.6692,77.4538],"Hubballi":[15.3647,75.1240],
    "Mangaluru":[12.9141,74.8560],"Udaipur":[24.5854,73.7125],
    "Aurangabad":[19.8762,75.3433],"Thane":[19.2183,72.9781],
    "Kota":[25.2138,75.8648],"Kozhikode":[11.2588,75.7804],
    "Warangal":[17.9689,79.5941],"Raipur":[21.2514,81.6296],
    "Varanasi":[25.3176,82.9739],"Agra":[27.1767,78.0081],
    "Amritsar":[31.6340,74.8723],"Jabalpur":[23.1815,79.9864],
    "Meerut":[28.9845,77.7064],"Navi Mumbai":[19.0330,73.0297],
    "Tiruchirappalli":[10.7905,78.7047],"Guntur":[16.3067,80.4365],
}
